...
// Plan details (sync with your PricingPlans)
const PLAN_DETAILS: Record<string, { amount: string; productinfo: string }> = {
...
// Use BASE_URL instead of NEXT_PUBLIC_BASE_URL for a plain React app
