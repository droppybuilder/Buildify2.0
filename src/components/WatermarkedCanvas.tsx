         ...
         {showWatermark && (
            <div className='absolute inset-0 pointer-events-none select-none'>
               <div className='absolute inset-0 flex items-center justify-center opacity-20'>
                  <div className='transform rotate-45 text-gray-600 font-bold text-4xl'>BUILDFY WEB</div>
               </div>
               <div className='absolute bottom-2 right-2 text-xs text-gray-500'>Upgrade to remove watermark</div>
            </div>
         )}
      </div>
   )
